            ...
            if ($(".formHintBubble").remove(), 10 == i.length || 11 == i.length)
                if (10 == (i = i.replace(/[^0-9]/g, "")).length || 11 == i.length);
                    ...
                    var n = $(t).parent().parent(),
                        a = parseFloat($(t).parent().css("top")) - 35,
    ...
    popupForm = function(t, e) {
        ...
        if (n && n.attr("lp-id-pop-sub") && n.attr("lp-id-pop-sub").length > 0) {
            ...
            if (n.attr("lp-ss-f") && n.attr("lp-ss-f").length > 0) {
                ...
                r && r.length > 0 && (o += "&utm_source=" + r), l && l.length > 0 && (o += "&utm_medium=" + l), s && s.length > 0 && (o += "&utm_campaign=" + s), c && c.length > 0 && (o += "&utm_term=" + c), p && p.length > 0 && (o += "&utm_content=" + p);
                n.find(".widget-element .widget-content");
                if (o && o.length > 0) {
                    var d = "?",
                        h = n.attr("lp-id-pop-url").split("/");
            ...
            $(".popup.ladi-popup-form").hide(), $('.widget-section[lp-popup="true"]').hide();
            var m = "";
            m += '<div class="popup ladi-popup-form" data-form="' + e + '" style="display:none;"> <div class="popup-dialog bounceIn animated" style="display: none;"> <div class="popup-header">', m += '<h3 class="popup-title">ThÃ´ng bÃ¡o </h3> <button class="close-popup">x</button>', m += '</div> <div class="popup-content">' + i + "</div> </div> </div>", $("body").append(m), $(".ladi-popup-form").show(), $(".ladi-popup-form").css({
                position: "fixed"
...
function showWatermark(t) {
    if ("1" == t) {
        setInterval(function() {
            $("body").find(".lp-watermart").length > 0 || ($("body").append('<div class="lp-watermart" style="background: #EAEBEE;display: block!important;position: fixed;bottom: 0px;left: 0px;width: 100%; height: 32px;z-index: 9999999999; text-align: center"><a style="width: 100%; height: 100%; display: inline-block;" href="https://ladipage.vn/?utm_source=freemium" target="_blank"><img src="https://static.ladipage.net/source/ladipage.png"></a></div>'), $("body").css({
                "margin-bottom": "32px!important"
            }));
            for (var t = document.getElementsByTagName("link"), e = 0, i = 0; i < t.length; i++) "image/ico" == t[i].type && "shortcut icon" == t[i].rel && (t[i].href = "https://note9.sharenows.com/favicon.ico", e = 1);
            0 == e && $("head").append('<link rel="shortcut icon" type="image/ico" href="https://note9.sharenows.com/favicon.ico">')
        }, 2e3)
    }
}
                ...
                if (inputRequired && inputRequired.length > 0) inputRequired.each(function(t) {
                    if (!this.validity.valid) {
                        ...
                        var e = formTarget.find(".widget-content:eq(0)"),
                            ...
                            o = parseFloat($(this).parent().css("top")) - 35,
